...
const Sandwich = function (bread, meat, spread) {
  this.bread = bread
  this.meat = meat
  this.spread = spread
}
...
const RoadTrip = function (gasLeft) {
  this.gasLeft = 100
  this.drive = function() {
...
const CoinToss = function (results) {
  this.results = []
  this.flip = function () {
    (Math.floor(Math.random() * 2) == 0) ? this.results.push('heads') : this.results.push('tails')
    return this.results
  }
}
